...
import 'package:login/app/controllers/disclamer_controller.dart';
...
class DisclaimerScreen extends StatelessWidget {
  final DisclaimerController disclaimerController =
      Get.put(DisclaimerController());
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                disclaimerController.navigateToHomeScreen();
              },
