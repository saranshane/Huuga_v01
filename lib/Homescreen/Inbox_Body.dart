...
// import 'package:login/Message_Screen/MessageScreen.dart';
...
//           Uri.parse('http://localhost:3000/api/conversations/?userId=660be75b9940f152d687a95b')); // Replace 'YOUR_BACKEND_API_URL' with your actual backend API URL

//       if (response.statusCode == 200) {
//         final Map<String, dynamic> responseData = json.decode(response.body); // Parse JSON response
//         final List<dynamic> conversationList = responseData['conversations'];
//         setState(() {
//           conversations = conversationList.map((data) => Conversation.fromJson(data)).toList(); // Convert JSON data to List<Conversation>
...
//                   children: [
//                     Text(
//                       conversation.recipients[1].name, // Assuming the first recipient's name is used
...
//                       opacity: 0.64,
//                       child: Text(
//                         conversation.text, // Assuming the conversation text is used
//                         maxLines: 1,
...
//             Opacity(
//               opacity:0.64,
//               child: Text(conversation.updatedAt.toString()), // Assuming updatedAt is used
//             ),
//           ],
//         ),
//       ),
